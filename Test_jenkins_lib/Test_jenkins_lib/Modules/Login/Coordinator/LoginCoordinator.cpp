...
LoginCoordinator::LoginCoordinator(IPasswordLoginView* ipasswordLoginView, IVerificationLoginView* iverificationLoginView, IRegisterView* iregisterView) {
    // 创建视图
    passwordLoginView = ipasswordLoginView;
    verificationLoginView = iverificationLoginView;
